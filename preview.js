...
(() => {
    ...
    const observer = observe({
      ...
      '.nav-tabs': el => {
        el.classList.add('mb-40', 'border-0', 'text-body', 'font-medium')
      }, 
      // Updates nav link style
      '.nav-link': el => {
        el.classList.add('rounded-0', 'bg-none', 'text-slate-3', 'border-grey-3', 'border-b-2', 'border-t-0', 'border-l-0', 'border-r-0')
      },                
      // Updates nav active link style
      '.nav-link.active': el => {
        el.classList.remove('bg-none', 'border-grey-3', 'border-b-2')
        el.classList.add('bg-slate-1', 'border-slate-2', 'border-b-4')
      }, 
